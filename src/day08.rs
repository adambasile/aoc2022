...
fn partone(trees: &Vec<Vec<(usize, usize, i32)>>) -> i32 {
...
fn get_lines_of_trees_from_tree(
    ...
    top_line.reverse();
    [left_line, right_line[1..].into(), top_line.into(), bottom_line[1..].into()]
}
